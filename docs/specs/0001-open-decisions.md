...
**Status:** open — OD-1 / OD-2 / OD-3 / OD-5 closed 2026-06-17. **OD-4, OD-6 (partial), OD-7 remain open — don't default them; ask.** **Last reviewed:** 2026-06-17.
...
> Treat every **still-open** decision above (OD-4, OD-6 remainder, OD-7) as undefined: **ask, don't assume.**
