...
| [0021](0021-data-pack-connector.md) | Data packs as a connector — curated document sets as a managed source | Proposed |
| [0022](0022-group-access-model.md) | Group access model — group principals, and who a source is visible to (supersedes 0021 §5) | Proposed |
